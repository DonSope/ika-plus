...
//                 based on an original script from Anh Tuan Nguyen Dao (http://www.atdao.dk) (Update by michalis)
//                 Almost entirely rewritten for ikariam v0.5.0,
...
// @include        http://s*.ikariam.gameforge.com/?*&oldBackgroundView=city&*
